                    ...
                    if ($_SERVER ["REQUEST_METHOD"] == "POST"){
                        ...
                        if($verificar_usuario==false){
                            ...
                            if($usuario->verificarUsuario($conn)){
                                echo "<p class='mensaje'>Has sido registrado con éxito.</p>";
                            }else{
                                echo "<p class='mensaje'>Hubo un error</p>";
                            }
                    }else{
                        echo "<p class='mensaje'>El correo ingresado ya fue empleado para crear otro usuario, intente con otro correo.</p>";
                    }}
                ?>
